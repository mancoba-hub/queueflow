...
public class EmailService : IEmailService
{
    ...
    {
        var subject = "Welcome to Queue Flow API!";
        var body = $@"
            <html>
            <body>
                <h2>Welcome, {firstName}!</h2>
                <p>Thank you for joining Queue Flow API. We're excited to have you on board!</p>
                <p>Your account has been successfully created and you can now start using our services.</p>
                <p>If you have any questions, please don't hesitate to contact our support team.</p>
                <br>
                <p>Best regards,<br>The Queue Flow API Team</p>
            </body>
            </html>";
